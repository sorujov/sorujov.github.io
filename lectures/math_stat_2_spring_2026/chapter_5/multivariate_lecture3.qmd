...
viewof countdown = {
  ...
  function updateDisplay() {
    ...
    container.textContent = `⏱️ ${minutes}:${seconds.toString().padStart(2, '0')}`;
...
## 📊 Interactive: Portfolio Risk vs Correlation {.smaller}
...
**Portfolio:** w₁=${(w1_slider * 100).toFixed(0)}%, w₂=${(w2 * 100).toFixed(0)}% | σₚ=${(portfolio_std * 100).toFixed(2)}% | ρ=${rho_slider.toFixed(1)}
:::
