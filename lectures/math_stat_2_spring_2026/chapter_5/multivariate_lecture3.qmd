...
- **Expected Value of Functions** – Definition 5.9 and computing $E[g(Y_1, Y_2)]$

- **Theorems on Expected Values** – Linearity and fundamental result $E[Y_1 + Y_2] = E[Y_1] + E[Y_2]$

- **Covariance** – Definition, interpretation, computational formula

- **Correlation Coefficient** – Standardized covariance and properties

- **Case Study** – Portfolio optimization with real data
:::
:::

## 📖 Motivation: Why Covariance and Correlation?
...
::: {style="font-size: 35px"}
::: {.callout-note}
## 📝 Definition 5.9: Expected Value of $g(Y_1, Y_2)$
...
## 📌 Example 1: Computing $E[Y_1 \cdot Y_2]$
...
## 📌 Example 2: Computing $E[Y_1]$ from Joint Density
...
## 📌 Example 3: Expected Portfolio Return
...
::: {style="font-size: 34px"}
**Key Point:** Expected portfolio return is simply the weighted average of individual expected returns—**no covariance needed!**
:::

## 🧮 Theorem 5.9: Independence and Expected Values
...
## 🧮 Theorem 5.10: Computational Formula for Covariance
...
::: {.columns}
::: {.column width="50%" .fragment style="font-size: 32px;"}
...
::: {.callout-note}
## 📝 Definition 5.11: Correlation Coefficient
...
## 🧮 Theorem 5.11: Variance of Linear Combinations
...
## 📌 Example 5: Portfolio Standard Deviation
...
## 🎯 Minimum Variance Portfolio: The Optimization Problem
...
## 📊 Interactive: Minimum Variance Portfolio vs Correlation {.smaller}
...
<strong>Minimum Variance Portfolio:</strong> w₁* = ${(w1_star * 100).toFixed(1)}%, 
w₂* = ${(w2_star * 100).toFixed(1)}% | 
σₚ = ${(min_std * 100).toFixed(2)}% | 
ρ = ${rho_slider.toFixed(2)}<br>
<em style="font-size: 0.9em;">Optimal weights change with correlation! Lower ρ → greater diversification benefit</em>
</div>`
```

:::

## 💰 Case Study: Real Portfolio Data {.smaller}
...
## 💰 Case Study: Correlation Matrix {.smaller}
...
- **SPY-TLT:** Low/slightly negative correlation → good diversification
- **SPY-GLD:** Low positive correlation → some diversification benefit
- **TLT-GLD:** Moderate positive correlation → less diversification between these two

**Investment Implication:** Combining stocks (SPY) with bonds (TLT) provides excellent risk reduction due to low correlation.
:::
:::

## 💰 Case Study: Portfolio Analysis {.smaller}
...
- SPY-TLT: Low/negative → good diversification

- SPY-GLD: Low positive → some benefit
...
Low/negative ρ reduces variance!
:::
:::
...
## 📝 Quiz #1: Computing Expected Value {.quiz-question}

::: {style="font-size: 34px"}
If $E[Y_1] = 5$, $E[Y_2] = 10$, what is $E[3Y_1 + 2Y_2 - 7]$?

- [28]{.correct data-explanation="✅ Correct! By linearity: E[3Y₁ + 2Y₂ - 7] = 3E[Y₁] + 2E[Y₂] - 7 = 3(5) + 2(10) - 7 = 15 + 20 - 7 = 28"}
- 35
- 22
- 15
:::

## 📝 Quiz #2: Covariance Computation {.quiz-question}

::: {style="font-size: 34px"}
If $E[Y_1] = 2$, $E[Y_2] = 3$, and $E[Y_1 Y_2] = 7$, what is $\text{Cov}(Y_1, Y_2)$?

- [1]{.correct data-explanation="✅ Correct! Using the computational formula: Cov(Y₁, Y₂) = E[Y₁Y₂] - E[Y₁]E[Y₂] = 7 - (2)(3) = 7 - 6 = 1"}
- 6
- 7
- -1
:::

## 📝 Quiz #3: Independence and Covariance {.quiz-question}

::: {style="font-size: 32px"}
Which statement about covariance is TRUE?

- [If two variables are independent, their covariance must be zero]{.correct data-explanation="✅ Correct! Independence implies E[Y₁Y₂] = E[Y₁]E[Y₂], so Cov = E[Y₁Y₂] - E[Y₁]E[Y₂] = 0. However, the converse is false—zero covariance does not imply independence."}
...
## 📝 Quiz #4: Portfolio Variance {.quiz-question}

::: {style="font-size: 32px"}
For a portfolio with $w_1 = w_2 = 0.5$, $\sigma_1 = \sigma_2 = 20\%$, and $\rho = 0$, what is the portfolio standard deviation?

- [14.14%]{.correct data-explanation="✅ Correct! V(Rₚ) = 0.5²(0.20²) + 0.5²(0.20²) + 2(0.5)(0.5)(0)(0.20)(0.20) = 0.01 + 0.01 + 0 = 0.02. So σₚ = √0.02 = 0.1414 = 14.14%"}
- 20%
- 10%
- 28.28%
:::
...
✅ Master the portfolio variance formula

✅ Remember: Cov = 0 ≠ independence!
