...
## 📖 Why Study Multivariate Distributions? {.smaller .r-fit-text}
...
<p><strong>on</strong> [0,1] × [0,1]</p>
<p><strong>Normalizing constant:</strong><br/>
<em>c</em> = (α+1)(β+1) = ${c_constant.toFixed(2)}</p>
</div>`
```

**Observations:**  

- Higher α → density near y₁ = 1

- Higher β → density near y₂ = 1
...
## 🤝 Think-Pair-Share: Investment Decision {.smaller .r-fit-text}
...
## 💰 Case Study: Portfolio Returns Analysis (Real Data) {.smaller}
