...
$P(-1 \leq Z \leq 1) \approx 0.68$ and $P(-2 \leq Z \leq 2) \approx 0.95$ and $P(-3 \leq Z \leq 3) \approx 0.997$
:::

**Risk Management Application:** If stock returns are $N(8\%, 5\%)$, 95% of returns fall between $8\% - 2(5\%) = -2\%$ and $8\% + 2(5\%) = 18\%$.

## 🤝 Think-Pair-Share: The Empirical Rule {.r-fit-text}
...
## 📌 Example 1: Solution (cont'd){.smaller}
...
## 📌 Example 2: Solution (cont'd) {.smaller}
...
## 📌 Example 4: Solution (cont'd) {.smaller}
...
## 💰 Case Study: Visualization and Normality Assessment {.r-fit-text}
