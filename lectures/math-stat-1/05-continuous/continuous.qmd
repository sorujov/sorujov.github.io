...
$$P(1 \leq Y \leq 2) = \int_{1}^{2} \frac{3}{8}y^2 \, dy = \frac{3}{8} \int_{1}^{2} y^2 \, dy$$

. . .

**Step 2:** Evaluate:
$$\frac{3}{8} \left[\frac{y^3}{3}\right]_1^2 = \frac{3}{8} \left(\frac{8}{3} - \frac{1}{3}\right) = \frac{3}{8} \cdot \frac{7}{3} = \frac{7}{8}$$
