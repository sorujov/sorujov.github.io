...
::: {.fragment}
**Integration Method:**
$$P(4 \leq X \leq 6) = \int_{4}^{6} \frac{1}{6} \, dx = \frac{1}{3}$$
:::
:::
...
::: {.fragment}
**Shortcut Method:**
$$P(4 \leq X \leq 6) = \frac{6-4}{8-2} = \frac{1}{3}$$
(length ratio)
:::
:::
...
$$E(Y) = \int_{-\infty}^{\infty} y f(y) \, dy = \int_{\theta_1}^{\theta_2} y \left(\frac{1}{\theta_2 - \theta_1}\right) \, dy = \frac{1}{\theta_2 - \theta_1} \int_{\theta_1}^{\theta_2} y \, dy = \frac{1}{\theta_2 - \theta_1} \left[\frac{1}{2}y^2\right]_{\theta_1}^{\theta_2}$$
...
## 🎮 Interactive: Uniform Mean and Variance {.r-fit-text}
...
## 💰 Case Study: Investment Holding Period Returns (Real Data) {.r-fit-text}
