...
**Application**: Used by actuaries for pricing, reserving, and risk assessment 
:::
:::
:::
:::
...
# alpha ≈ 1.5 (right-skewed), beta ≈ 8000
alpha_true <- 1.5
beta_true <- 8000
...
## 💰 Case Study: Actuarial Applications and Pricing {.smaller}
...
3. **Policy limit design**: Setting limit at $50,000 covers 97% of claims, balancing coverage and affordability 
